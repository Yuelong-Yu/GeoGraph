...
const messages = {
  en: {
    ...
    fixedAxisRotation: "Fixed axis",
    freeRotation: "Free rotation",
    showTerritoryNames: "Show territory names",
    hideTerritoryNames: "Hide territory names",
    showTerritoryLayer: "Show territory layer",
    hideTerritoryLayer: "Hide territory layer",
    ...
    activePeople: "People active in this year",
    activePeopleEmpty: "No active people have a known location in this year.",
    showActivePeople: "Show people active in this year",
    ...
    timelineHelp: "The timeline compresses early history and expands later history; scroll to zoom and Shift + scroll to pan",
    selectYear: "Select year",
    civilizationPeriods: "Human civilization periods",
    classicalAge: "Classical age",
    medievalWorld: "Medieval world",
    industrialAge: "Industrial age",
    informationAge: "Information age",
    renaissanceReformation: "Renaissance & Reformation",
    ageOfExploration: "Age of Exploration",
    enlightenmentRevolutions: "Enlightenment & revolutions",
  ...
  zh: {
    ...
    interactionHint: "左键拖动旋转 · 滚轮缩放",
    interactiveGlobe: "交互式历史地球",
    globalView: "全球视角",
    fixedAxisRotation: "固定转轴",
    freeRotation: "自由旋转",
    showTerritoryNames: "显示疆域名称",
    hideTerritoryNames: "隐藏疆域名称",
    showTerritoryLayer: "显示疆域图层",
    hideTerritoryLayer: "隐藏疆域图层",
    ...
    activePeople: "当前年份活跃人物",
    activePeopleEmpty: "当前年份没有具有已知位置的活跃人物。",
    showActivePeople: "展示该期全部人物",
    timeline: "历史时间轴",
    currentEra: "当前纪年",
    previousFrame: "上一帧",
    nextFrame: "下一帧",
    ...
    speed: "速度",
    yearsPerSecond: "年/秒",
    timelineHelp: "时间轴按前密后疏展示；滚轮缩放时间范围，Shift + 滚轮平移",
    selectYear: "选择年份",
    civilizationPeriods: "人类文明分期",
    classicalAge: "古典时代",
    medievalWorld: "中世纪与区域文明",
    industrialAge: "工业化时代",
    informationAge: "信息化时代",
    renaissanceReformation: "文艺复兴与宗教改革",
    ageOfExploration: "大航海时代",
    enlightenmentRevolutions: "启蒙与资产阶级革命",
